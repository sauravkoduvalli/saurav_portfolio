  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-start justify-center bg-white text-black dark:bg-[#18181b] dark:text-white px-4 pt-30 md:pt-36 lg:pt-40">
      <div className="w-full max-w-5xl px-4 md:px-8 lg:pl-16 flex flex-col items-start justify-center min-h-[80vh]">
        ...
        >
          I'm Saurav, a mobile and web application developer based in Kochi,
          Kerala. With over 4.6 years of experience, I build scalable
          cross-platform apps using Flutter, React Native, and React.js. I'm
          passionate about crafting clean UIs, integrating robust backends, and
          transitioning toward full-stack development.
        </motion.p>
